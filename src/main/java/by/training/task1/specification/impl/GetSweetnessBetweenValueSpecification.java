...
public class GetSweetnessBetweenValueSpecification implements SweetnessSpecification {

    private double minValue;
    private double maxValue;

    public GetSweetnessBetweenValueSpecification(double minValue, double maxValue) {
